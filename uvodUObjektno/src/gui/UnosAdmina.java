...
public class UnosAdmina extends JFrame {
	...
	private Administrator prijavljeni;
	
	public UnosAdmina(Korisnici korisnici, Administrator prijavljeni) {
		...
		btnOK.addActionListener((ActionListener) new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(validacija()) {
					...
					if(prijavljeni == null) { 
						Administrator admin = new Administrator(id,ime, prezime, jmbg, pol, broj, korisnickoIme, lozinka, plata, false);
						korisnici.dodajAdministratora(admin);
					}else {
					...
					UnosAdmina.this.dispose();
					UnosAdmina.this.setVisible(false);
				}
			}
		});
	};
	...
	private boolean validacija() {
		...
		if(txtID.getText().trim().equals("")) {
			...
			String id = txtID.getText().trim();
			Administrator pronadjeni = korisnici.pronadjiAdmina(id);
			if(pronadjeni != null) {
